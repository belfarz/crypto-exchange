...
export default function Diamond() {
  return (
    <div className='p-2'>
    <span className='text-white text-lg'>Diamond $11300</span>
    <div>
      ...
      <span className='flex my-2 items-center'><GiCheckMark className='text-green-500' /><span className="mx-2">Chinese Group Moderation / Translation</span></span>
