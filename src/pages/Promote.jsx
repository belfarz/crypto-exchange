    ...
    <div className="flex flex-wrap justify-center">
        ...
        <div className="col-4  ">
            <div className=" flex flex-col p-2 ">
                ...
                <span className='flex'><input type="radio" name="options" id="option4" className='mr-2 '/> <label id='radio-label' htmlFor="option4" className=''>$150 - 1 DAY    $100- 1day+ installation channel     </label> </span>
