...
export default function Login({visible, onClose}) {
  ...
  return (
    ...
    onClick={handleClose}
>
  <div className=" p-5 rounded-lg w-[450px] aspect-w-1 aspect-h-1" id='login-container'>
    ...
    <div className="flex flex-col justify-start items-start">
      ...
      <input
        id='login-input'
        type="text"
        className="border border-gray-700 p-2 rounded mb-3 w-full text-white"
        required
      />
      ...
      <input
        id='login-input'
        type="password"
        className="border border-gray-700 p-2 rounded mb-6 w-full text-white"
        required
      />
    </div>
    <div className="text-center">
      <button className="px-5 py-2 bg-orange-400 mb-6 w-full text-white rounded">
        Sign in
      </button>
    </div>
