...
export default function Navbar() {
  ...
  return (
    ...
    <div className='sidebar fixed top-0 bottom-0 lg:left-0 w-[250px]  text-center shadow h-screen overflow-y-auto hidden lg:block' id='sidebar'>
      ...
      <div >
        <div className="p-2.5 mt-2 m-5 flex items-center rounded-md px-4 duration-300 cursor-pointer  ">
        ...
        <div className="p-2.5 mt-2 m-5 pb-10 flex items-center px-4 duration-300 cursor-pointer  " id='side-border'>
